...
import chiron.agents.analysts.sentiment_analyst as sentiment
...
def test_trader_prompt_states_constraint():
    from chiron.agents.schemas import TraderAction, TraderProposal
...
def test_sentiment_prompt_states_constraint(monkeypatch):
    from chiron.agents.schemas import SentimentBand, SentimentReport
