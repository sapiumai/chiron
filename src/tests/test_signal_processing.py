...
header.  The deterministic heuristic in ``chiron.agents.utils.rating``
...
from chiron.agents.utils.rating import RATINGS_5_TIER, parse_rating
from chiron.graph.signal_processing import SignalProcessor
