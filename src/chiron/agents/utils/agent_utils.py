...
from chiron.agents.utils.core_stock_tools import get_stock_data
from chiron.agents.utils.fundamental_data_tools import (
    get_balance_sheet,
    get_cashflow,
    get_fundamentals,
    get_income_statement,
)
from chiron.agents.utils.macro_data_tools import get_macro_indicators
from chiron.agents.utils.market_data_validation_tools import get_verified_market_snapshot
from chiron.agents.utils.news_data_tools import (
    get_global_news,
    get_insider_transactions,
    get_news,
)
from chiron.agents.utils.prediction_markets_tools import get_prediction_markets
from chiron.agents.utils.technical_indicators_tools import get_indicators
...
def get_language_instruction() -> str:
    ...
    """
    from chiron.dataflows.config import get_config
