...
from chiron.graph.analyst_execution import (
...
from chiron_cli.announcements import display_announcements, fetch_announcements
from chiron_cli.stats_handler import StatsCallbackHandler
from chiron_cli.utils import (
...
def analyze(
    ...
    if clear_checkpoints:
        from chiron.graph.checkpointer import clear_all_checkpoints
